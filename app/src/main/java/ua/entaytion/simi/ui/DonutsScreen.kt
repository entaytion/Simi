            ...
            Card(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Icon(
                                painter = painterResource(id = R.drawable.ic_donut),
                                ...
                                DropdownMenuItem(
                                        ...
                                        onClick = {
                                            ...
                                            upsert(
                                                    name,
                                                    +1
                                            ) // вибір = одразу додаємо 1 і ставимо дату
                                        }
                                )
                            }
                        }
                    ...
                    Text(
                            text = "Максимум $maxCountPerItem шт на одну позицію",
                        ...
                        entries.forEach { entry ->
                            Surface(
                                ...
                                Row(
                                    ...
                                    IconButton(onClick = { upsert(entry.name, -1) }) {
                                        Icon(
                                                imageVector = Icons.Filled.Remove,
                                                contentDescription = "Мінус",
                                                tint = MaterialTheme.colorScheme.onSurface
                                        )
                                    }
                                    ...
                                    IconButton(
                                            onClick = { upsert(entry.name, +1) },
                                            enabled = entry.count < maxCountPerItem
                                    ) {
                                        Icon(
