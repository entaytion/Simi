...
object SimiIcons {
    ...
    val Expiration: ImageVector = Icons.Rounded.Warning
    val DaysLeft: ImageVector = Icons.Rounded.Timer
    val Box: ImageVector = Icons.Rounded.Inventory2
    ...
    val Notify: ImageVector = Icons.Rounded.Notifications
    val Dairy: ImageVector = Icons.Rounded.LocalGroceryStore
